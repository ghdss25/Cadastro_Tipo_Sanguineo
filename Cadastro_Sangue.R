...
typeof(cadastro_sangue$Peso)
typeof(cadastro_sangue$Altura)

cadastro_sangue$Imc = cadastro_sangue$Peso / ((cadastro_sangue$Altura / 100) * (cadastro_sangue$Altura / 100))

View(cadastro_sangue$Imc)

## cadastro_sangue["IMC"] <- c(cadastro_sangue$Imc, round(2))

View(cadastro_sangue)

############ Gráfico 1 - IMC por Titulo ##############
...
############ Gráfico 2 - Peso e Altura por Cidade ############
...
########## Gráfico 3 - IMC por Cidade ########## 

esquisser(cadastro_sangue)
...
####### Gráfico 4 - IMC por Tipo Sanguineo ######## 
...
############ Gráfico 7 - IMC por Nome ############

esquisser(cadastro_sangue$Nome)
...
############ Gráfico 8 - Ultima Consulta de IMC por Ano ############
esquisser(cadastro_sangue)
...
############ Gráfico 10 - Imc por Tipo Sanguineo e Cidade 
